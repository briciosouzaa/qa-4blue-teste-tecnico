...
## 6. Quais 2 bugs corrigiria primeiro e por quê
...
**Descrição**  
O formulário permite a criação de conta mesmo quando nenhum campo é preenchido.
...
**Descrição**  
Ao inspecionar o campo de senha no navegador, o valor da senha digitada aparece no atributo value do input.
...
**Resultado atual**  
A senha digitada aparece no atributo value.

**Resultado esperado**  
A senha não deve ficar exposta no DOM.
...
**Descrição**
O sistema permite acesso mesmo quando as credenciais informadas são inválidas ou inexistentes.
...
**Resultado esperado**
O sistema deve validar credenciais antes de permitir acesso.
...
**Descrição**
É possível acessar a área interna do sistema diretamente através da URL, sem autenticação.
...
**Resultado atual**
A página é carregada mesmo sem login.

**Resultado esperado**
O sistema deve redirecionar o usuário para a tela de login caso não esteja autenticado.
...
**Descrição**
O campo “Nome completo” permite cadastro utilizando apenas um nome.
...
**Resultado esperado**
O sistema deve exigir nome e sobrenome ou alterar o label para apenas "Nome".
...
**Descrição**
O campo telefone sugere um formato específico, mas não aplica máscara automática.
...
**Resultado atual**
Aceita números sem formatação e caracteres.

**Resultado esperado**
Aplicar máscara automaticamente ou validar formato não permitindo caracteres, somente números.
...
**Descrição**
O sistema não apresenta feedback de erro ao usuário quando dados inválidos são inseridos.
...
**Resultado atual**
Nenhuma mensagem ou indicação visual aparece.

**Resultado esperado**
O sistema deve apresentar mensagens claras de validação.
...
**Descrição**
Após realizar login, o sistema apresenta mensagem de erro mesmo quando o acesso ocorre.
...
**Resultado atual**
Mensagem “Erro inesperado” aparece após login.

**Resultado esperado**
Caso o login seja bem sucedido, nenhuma mensagem de erro deve ser exibida.
